...
@section('content')
    <div>
        ...
        <form method="POST" action="{{ route('theme-setting.store') }}">
            @csrf
            <div class="" style="max-width: 500px; margin: auto;">
                <div class="card">
                    <div class="card-body">
                        <button class="btn w-100 btn-primary mb-5">Save</button>
                        ...
                        <button class="btn w-100 btn-primary mt-5">Save</button>
                    </div>
                </div>
            </div>
        </form>
