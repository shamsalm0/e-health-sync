<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $machines->total() }}">
            <button type="button"
            ...
            @can('Machine Add')
                <a class="btn btn-primary" href="{{ route('machine.create') }}">
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($machines as $machine)
                            <tr>
                                <td scope="row">{{ $machines->firstItem() + $loop->index }}</td>
                                <td>{{ $machine->name }}</td>
                                <td>{{ $machine->description }}</td>
                                <td><x-status :status="$machine->status" /></td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $machine->id }})'>
