<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $specializations->total() }}">
            <button type="button"
            ...
            @can('Specialization Add')
                <a class="btn btn-primary" href="{{ route('specialization.create') }}">
                    <i class="mdi mdi-plus"></i> Add Specialization
                </a>
            @endcan
        </x-list-header>
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($specializations as $specialization)
                            <tr>
                                <td scope="row">{{ $specializations->firstItem() + $loop->index }}</td>
                                <td>{{ $specialization->name }}</td>
                                <td><x-status :status="$specialization->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a href="{{ route('specialization.show', $specialization->id) }}" class="dropdown-item">
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $specialization->id }})'>
