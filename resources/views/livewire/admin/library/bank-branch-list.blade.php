<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $bankBranches->total() }}">
            <button type="button"
            ...
            @can('Bank Branch Add')
                <a class="btn btn-primary" href="{{ route('bank-branch.create') }}">
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a href="{{ route('bank-branch.show', $bankBranch->id) }}" class="dropdown-item">
                                            ...
                                            <li>
                                                <a href="{{ route('bank-branch.edit', $bankBranch->id) }}"
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $bankBranch->id }})'>
