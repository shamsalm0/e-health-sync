<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $districts->total() }}">
            <button type="button"
            ...
            @can('District Add')
                <a class="btn btn-primary" href="{{ route('district.create') }}">
                    <i class="mdi mdi-plus"></i> Add District
                </a>
            @endcan
        </x-list-header>
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($districts as $district)
                            <tr>
                                <td scope="row">{{ $districts->firstItem() + $loop->index }}</td>
                                <td>{{ $district->name }}</td>
                                ...
                                <td>{{ $district->lon }}</td>
                                <td>{{ $district->url }}</td>
                                <td><x-status :status="$district->status" /></td>
                                <td>
                                            ...
                                            @can('District Delete')
                                                <li>
                                                    <a type="button" class="dropdown-item remove-item-btn"
                                                        wire:click='$dispatch("delete_resource",{{ $district->id }})'>
