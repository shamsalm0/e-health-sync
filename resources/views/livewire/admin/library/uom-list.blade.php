<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $uoms->total() }}">
            <button type="button"
            ...
            @can('Uom Add')
                <a class="btn btn-primary" href="{{ route('uom.create') }}">
            ...
            <div class="card-body">
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($uoms as $uom)
                            <tr>
                                <td scope="row">{{ $uoms->firstItem() + $loop->index }}</td>
                                <td>{{ $uom->name }}</td>
                                <td>{{ $uom->details }}</td>
                                <td><x-status :status="$uom->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            @can('Uom View')
                                            <li>
                                                <a href="{{ route('uom.show', $uom->id) }}" class="dropdown-item">
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $uom->id }})'>
