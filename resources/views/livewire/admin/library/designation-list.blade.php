<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $designations->total() }}">
            <button type="button"
            ...
            @can('Designation Add')
                <a class="btn btn-primary" href="{{ route('designation.create') }}">
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($designations as $designation)
                            <tr>
                                <td scope="row">{{ $designations->firstItem() + $loop->index }}</td>
                                <td>{{ $designation->name }}</td>
                                <td>{{ $designation->discription }}</td>
                                <td><x-status :status="$designation->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a href="{{ route('designation.show', $designation->id) }}" class="dropdown-item">
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $designation->id }})'>
