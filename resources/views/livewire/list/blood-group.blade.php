<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $bloodGroups->total() }}">
            <button type="button"
            ...
            <a class="btn btn-primary" href="{{ route('blood-group.create') }}">
                <i class="mdi mdi-plus"></i> Add Blood Group
            </a>
        </x-list-header>
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($bloodGroups as $bloodGroup)
                            <tr>
                                <td scope="row">{{ $bloodGroups->firstItem() + $loop->index }}</td>
                                <td>{{ $bloodGroup->name }}</td>
                                <td><x-status :status="$bloodGroup->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('blood-group.show', $bloodGroup->id) }}"
                                                    class="dropdown-item">
                                            ...
                                            <li>
                                                <a href="{{ route('blood-group.edit', $bloodGroup->id) }}"
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $bloodGroup->id }})'>
