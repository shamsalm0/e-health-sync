<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $empBoards->total() }}">
            <button type="button"
            ...
            <a class="btn btn-primary" href="{{ route('emp-board.create') }}">
                <i class="mdi mdi-plus"></i> Add Board
            </a>
        </x-list-header>
        ...
        <div class="card mb-3">
            <div class="card-body">
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($empBoards as $empBoard)
                            <tr>
                                <td scope="row">{{ $empBoards->firstItem() + $loop->index }}</td>
                                <td>{{ $empBoard->name }}</td>
                                <td>{{ $empBoard->is_board? 'Yes' : 'No' }}</td>
                                <td><x-status :status="$empBoard->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('emp-board.show', $empBoard->id) }}"
                                                    class="dropdown-item">
                                            ...
                                            <li>
                                                <a href="{{ route('emp-board.edit', $empBoard->id) }}"
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $empBoard->id }})'>
