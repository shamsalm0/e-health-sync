<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $genders->total() }}">
            <button type="button"
            ...
            @can('Gender Add')
                <a class="btn btn-primary" href="{{ route('gender.create') }}">
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($genders as $gender)
                            <tr>
                                <td scope="row">{{ $genders->firstItem() + $loop->index }}</td>
                                <td>{{ $gender->name }}</td>
                                <td><x-status :status="$gender->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('gender.show', $gender->id) }}" class="dropdown-item">
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $gender->id }})'>
