<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $religions->total() }}">
            <button type="button"
            ...
            @can('Religion Add')
            <a class="btn btn-primary" href="{{ route('religion.create') }}">
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($religions as $religion)
                            <tr>
                                <td scope="row">{{ $religions->firstItem() + $loop->index }}</td>
                                <td>{{ $religion->name }}</td>
                                <td><x-status :status="$religion->status" /></td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $religion->id }})'>
