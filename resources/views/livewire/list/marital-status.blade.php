<div>
    ...
    <div class="mb-3 ">
        ...
        <x-list-header total="{{ $maritalStatuses->total() }}">
            <button type="button"
            ...
            @can('Marital Status Add')
                <a class="btn btn-primary" href="{{ route('marital-status.create') }}">
                    <i class="mdi mdi-plus"></i> Add Marital Status
                </a>
            @endcan
        </x-list-header>
                ...
                <x-table>
                    ...
                    <x-tbody>
                        @foreach ($maritalStatuses as $maritalStatus)
                            <tr>
                                <td scope="row">{{ $maritalStatuses->firstItem() + $loop->index }}</td>
                                <td>{{ $maritalStatus->name }}</td>
                                <td><x-status :status="$maritalStatus->status" /></td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('marital-status.show', $maritalStatus->id) }}"
                                                    class="dropdown-item">
                                            ...
                                            <li>
                                                <a href="{{ route('marital-status.edit', $maritalStatus->id) }}"
                                            ...
                                            <li>
                                                <a type="button" class="dropdown-item remove-item-btn"
                                                    wire:click='$dispatch("delete_resource",{{ $maritalStatus->id }})'>
