                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <form autocomplete="off" action="{{ route('verify-contact.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="otp_digits[]" onkeyup="moveToNext(1,event)" maxLength="1"
                                                        id="digit1-input">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-lg bg-light border-light text-center"
                                                        name="otp_digits[]" onkeyup="moveToNext(2,event)" maxLength="1"
                                                        id="digit2-input">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-lg bg-light border-light text-center"
                                                        name="otp_digits[]" onkeyup="moveToNext(3,event)" maxLength="1"
                                                        id="digit3-input">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-lg bg-light border-light text-center"
                                                        name="otp_digits[]" onkeyup="moveToNext(4,event)" maxLength="1"
                                                        id="digit4-input">
                                                </div>
                                            </div><!-- end col -->
                                        </div>
                                        @error('contact_verify_otp')
                                            <small class="text-danger">
                                                <strong>{{ $message }}</strong>
                                            </small>
                                        @enderror
                                        <div class="mt-3">
                                            <button type="submit" class="btn btn-success w-100">Verify Contact</button>
                                        </div>
                                    </form><!-- end form -->
                                </div>
                            </div>
